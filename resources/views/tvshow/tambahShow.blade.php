...
@section('content')
	...
	<div class="container mt-5">
		<div class="row justify-content-center">
			...
			<div class="col-lg-4">
			 <form action="/tvshow/tambah" method="post" class="mb-5" enctype="multipart/form-data">
       		 {{ csrf_field() }}
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control @error('batasan_umur_tvshow') is-invalid @enderror" id="batasan_umur_tvshow" name="batasan_umur_tvshow" autofocus="" required="" value="{{ old('batasan_umur_tvshow') }}">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" name="id_episode" >
              @foreach($episode as $episode)
                @if(old('id_episode') === $episode->id_episode)
              <option value="{{ $episode->id_episode }}" selected>{{ $episode->nama_episode }}</option>
                @else
