...
<div class="container mt-5">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item">
        <div class="row">
          <div class="col-sm"><img style="max-height: 350px; overflow: hidden;" src="{{ asset('img/mz1.jpg') }}" width="185" height="278" alt="1 slide"></div>
          <div class="col-sm"><img style="max-height: 350px; overflow: hidden;" src="{{ asset('img/6under.jpg') }}" width="185" height="278" alt="2 slide"></div>
          <div class="col-sm"><img style="max-height: 350px; overflow: hidden;" src="{{ asset('img/allegiant.jpg') }}" width="185" height="278" alt="3 slide"></div>
          <div class="col-sm"><img style="max-height: 350px; overflow: hidden;" src="{{ asset('img/divergent.jpg') }}" width="185" height="278" alt="4 slide"></div>
          <div class="col-sm"><img style="max-height: 350px; overflow: hidden;" src="{{ asset('img/si.jpg') }}" width="185" height="278" alt="5 slide"></div>
      </div>
    </div>
